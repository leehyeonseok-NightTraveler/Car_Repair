...
<div class="edit-container">
  ...
  <form action="${pageContext.request.contextPath}/mypage_store/update" method="post" class="edit-form">
    ...
    <div class="form-group">
      ...
      <input type="text" id="storeName" name="storeName" value="${store.store_name}" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="tel" id="phoneNumber" name="phoneNumber" value="${store.phone_number}" placeholder="010-1234-5678" required>
    </div>

    <div class="form-group">
      <label for="openingHours">영업시간</label>
      <input type="text" id="openingHours" name="openingHours" value="${store.opening_hours}" placeholder="예: 09:00~18:00" required>
    </div>
